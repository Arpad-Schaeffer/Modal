...
\begin{figure}[H]
    \centering
    %\includegraphics[width=0.7\textwidth]{chemin/vers/graphique_optimisation.png}
...
\begin{figure}[H]
  ...
  {0.45\textwidth}
    \centering
    \include{matrice.tex}
    \caption{Configuration de la matrice des scintilateurs. Chaque scintillateurs est indéxé a la maniere des coeficients d'une matrice.}
...
Il sagit de choisir le bon treshold. Nous avons commencé par tracer grossierementr les caracteristiques de deux scintillateurs aleatoirement choiusis. Ces resultats sont representé figure \ref{fig:caracteristique_scintillateur_2}.
...
\begin{itemize}
  ...
  \item Expérience avec absorbeur de plomb : pertes par ionisation, bremv sstrahlung et capture.
