...
\begin{remarque}
\textbf{Synthèse~:} La chaîne électronique joue un rôle essentiel dans l’extraction des signaux utiles, leur traitement et leur analyse — qu’il s’agisse de mesurer le taux de détection ou de comptabiliser les coïncidences — tout en supprimant efficacement le bruit de fond.
\end{remarque}
...
\begin{itemize}
    \item \textbf{Scintillateur 1 :} Haute tension (HT) = \_\_\_\_~V, seuil du discriminateur = \_\_\_\_~V.
    \item \textbf{Scintillateur 2 :} Haute tension (HT) = \_\_\_\_~V, seuil du discriminateur = \_\_\_\_~V.
    \item \textbf{Scintillateur 3 :} Haute tension (HT) = \_\_\_\_~V, seuil du discriminateur = \_\_\_\_~V.
\end{itemize}
Ces valeurs permettent de maximiser le taux de détection des muons tout en minimisant le bruit de fond.
\end{remarque}
