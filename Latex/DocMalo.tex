...
% --- FIN ENCADRÉ PROBLÈMES ---

% --- Synthèse unique, concise, orientée résultats, avec trous à remplir ---
...
Pour chaque largeur de fenêtre de coïncidence (width), on a mesuré :
\begin{itemize}
    \item le nombre total de coïncidences enregistrées en 1 minute (sans délai)~;
...
% --- Encadré Problèmes rencontrés lors des coïncidences ---
...
\begin{itemize}
    ...
    \item \textbf{Choix du trigger} : il a fallu déterminer sur quel scintillateur déclencher la recherche de coïncidences (scintillateur 1, 2 ou 3), ce qui a nécessité des essais pour optimiser la détection.
